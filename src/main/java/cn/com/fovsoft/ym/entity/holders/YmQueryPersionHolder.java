...
public class YmQueryPersionHolder {
    ...
    private String sfcjylbx1;
    private String sfcjsybx;
    private String sfxsdb;
    private String sfcjylbx2;
    private String sfxsywbxbt;
    private String lxdh;
    ...
    public String getSfzyxqs() {
        return sfzyxqs;
    }

    public void setSfzyxqs(String sfzyxqs) {
    ...
    public void setSfzyxqz(String sfzyxqz) {
