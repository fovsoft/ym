...
(
    ...
    produce_xtxl1 char(2) comment '类别小类：01为种植业，02为林业，03为养殖业，04为其他 ,05为小计',
    produce_xtxl2 char(2) comment '类别小类：01为品种，02为数量，03为金额',
...
(
    ...
    jtbh        varchar(20) comment '家庭编号，对应家庭表 ,00为小计',
    xm          varchar(20) comment '姓名 ,00为小计',
    wggz        varchar(20) comment '务工工种 ,00为小计',
    wgdz        varchar(60) comment '务工省、市、县 ,00为小计',
    wgljsj      varchar(10) comment '务工累计时间（月）,00为小计',
    wgqymc      varchar(60) comment '务工企业名称 ,00为小计',
...
(
    ...
    jtbh          varchar(20) comment '家庭编号，对应家庭表',
    property_xtlb char(2) comment '财产收入类别：01，财产收益扶贫分红收入，02，其他 ,03为小计' ,
...
(
    ...
    jtbh     varchar(20) comment '家庭编号，对应家庭表',
    tra_xtlb char(4) comment '转移性财产类别:01，计划生育金；0201，低保金A；0202，低保金B；0203，低保金C；03,特困供养金；04，养老保险金；05，生态补偿金（林业补贴）；06，困难残疾人生活补贴和重度残疾人护理补贴；07，农业补贴；08，高龄补贴；09，水库移民补贴；10，其他长期性的政策性补贴 11，06-10项小计 12，01-10项小计',
...
04，产业奖补类；05，金融类(扶贫小额贷款)）；06，社会保障类(临时救助金等)；07，保险赔付金；08，残疾人补贴(除困难残疾人生活补贴和重度残疾人护理补贴)；09，捐赠金、慰问金、短期性赡养金、抚养金等；10，短期性抚恤金、优待金、补助金、保健金、伤残治疗费、护理费、丧葬费；11，其他短期性(3年以下，含3年)的政策性补助 ,12为小计',
